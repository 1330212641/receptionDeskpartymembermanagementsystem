						...
						<el-card style="margin-top:30px;">
							<el-row>
								<el-col :span="6">
									...
									<el-row :gutter="12" style="margin-top:30px;">
										<el-col :span="8">
											<div style="text-align:right;"><span>学号：</span></div>
										</el-col>
										<el-col :span="16">{{}}</el-col>
									</el-row>
									<el-row :gutter="12" style="margin-top:30px;">
									...
									<el-row :gutter="12" style="margin-top:30px;">
										<el-col :span="8">
											<div style="text-align:right;"><span>宿舍星级：</span></div>
										</el-col>
										<el-col :span="16">{{}}</el-col>
									</el-row>
									<el-row :gutter="12" style="margin-top:30px;">
										<el-col :span="8">
											<div style="text-align:right;"><span>党课情况：</span></div>
										</el-col>
										<el-col :span="16">{{}}</el-col>
									</el-row>
									<el-row :gutter="12" style="margin-top:30px;">
										<el-col :span="8">
											<div style="text-align:right;"><span>所处阶段：：</span></div>
										</el-col>
										<el-col :span="16">{{}}</el-col>
									</el-row>
								</el-col>
								<el-col :span="18">
									<el-row>
										<el-col>
											<el-timeline>
												<el-timeline-item timestamp="荣誉情况" placement="top">
													<el-card>
														<div><span><span
																	style="font-family:'宋体';font-size:10px;"><strong>奖励情况</strong></span><span
																	style="font-family:'宋体';font-size:10px;margin-left:20px;"><strong>123456</strong></span></span>
														</div>
														<div>
															<span>颁发单位{{}}</span><br>
															<span>荣誉名称{{}}</span><br>
												...
												<el-timeline-item timestamp="违纪情况" placement="top">
													<el-card>
														<div><span><span
																	style="font-family:'宋体';font-size:10px;"><strong>惩罚情况</strong></span><span
																	style="font-family:'宋体';font-size:10px;margin-left:20px;"><strong>123456</strong></span></span>
														</div>
														<div>
															<span>违纪情况：</span><br>
